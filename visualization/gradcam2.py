...
def runGradCam2(choose_network = 'AlexNet',
    ...
    # Save mask
    gray3,color3, result3 = save_class_activation_on_image(original_image, cam, 'NotSoNormie_'+file_name_to_export)
